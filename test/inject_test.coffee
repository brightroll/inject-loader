  ...
  describe 'loader', ->
    describe 'injecting', ->
      it 'injects all require statements by default', ->
        ...
        replacement = "(injections['lib/thing'] || /* istanbul ignore next */ require('lib/thing'))"
    ...
    describe 'queries', ->
      describe 'empty', ->
        ...
        it 'injects all modules', ->
          ...
          expect(injectedSrc).to.have.string "var Dispatcher = (injections['lib/dispatcher'] || /* istanbul ignore next */ require('lib/dispatcher'));"
          expect(injectedSrc).to.have.string "var EventEmitter = (injections['events'] || /* istanbul ignore next */ require('events')).EventEmitter;"
          expect(injectedSrc).to.have.string "var handleAction = (injections['lib/handle_action'] || /* istanbul ignore next */ require('lib/handle_action'));"
